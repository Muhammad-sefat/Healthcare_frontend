            ...
            <div className="lg:col-span-8 space-y-8">
              ...
              <div className="bg-white dark:bg-slate-900 border border-slate-150 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xs space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-xs sm:text-sm">
                  ...
                  <div className="space-y-4">
                    <div className="flex gap-3">
                      <div className="bg-slate-50 dark:bg-slate-800 p-2.5 rounded-xl text-slate-555 h-10 w-10 flex items-center justify-center flex-shrink-0">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <span className="block text-[9px] text-slate-405 font-medium">
            ...
            <div className="lg:col-span-4 bg-white dark:bg-slate-900 border border-slate-150 dark:border-slate-800 rounded-3xl p-6 shadow-xs space-y-6 sticky top-24">
              ...
              {doctorClaimedSlots.length > 0 ? (
                ...
                <div className="text-center py-12 px-4 border border-dashed border-slate-200 dark:border-slate-800 rounded-2xl space-y-3">
                  ...
                  <h4 className="font-bold text-xs text-slate-855 dark:text-slate-200">No Schedules Available</h4>
      ...
      >
        <form onSubmit={handleConfirmPayment} className="space-y-6">
          <div className="bg-slate-50 dark:bg-slate-800 p-4 rounded-xl flex justify-between text-xs text-slate-500">
            <div>
              <span className="block font-semibold text-slate-755 dark:text-slate-300">Appointment with:</span>
              <span>{doctor.name}</span>
            </div>
            <div className="text-right">
              <span className="block font-semibold text-slate-755 dark:text-slate-300">Total Amount:</span>
        ...
        <div className="text-center py-6 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-xs text-slate-505 max-w-sm mx-auto leading-relaxed">
              Your appointment with <span className="font-bold text-slate-755 dark:text-slate-300">{doctor.name}</span> has been confirmed. 
              {bookingType === "pay_now" 
