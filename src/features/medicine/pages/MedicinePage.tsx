...
export function MedicinePage() {
  ...
  return (
    <div className="bg-slate-50 dark:bg-slate-955 min-h-screen py-10 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        
        {/* Header / Pharmacy Showcase */}
        <div className="bg-gradient-to-r from-emerald-500/10 via-teal-500/5 to-slate-955/0 border border-slate-150 dark:border-slate-800 rounded-3xl p-6 sm:p-10 shadow-xs flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="space-y-4 max-w-2xl text-center md:text-left">
            <span className="bg-emerald-100 dark:bg-emerald-955 text-emerald-600 dark:text-emerald-400 text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">
              CarePulse Pharmacy
            </span>
            <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-none">
              Order Genuine Medicines Online
            </h1>
                  ...
                  <div key={item.product.id} className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3 gap-4">
                    ...
                    <div className="flex items-center gap-3 flex-shrink-0">
                      ...
                      <button 
                        ...
                        className="text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-955/40 p-2 rounded-lg transition-colors cursor-pointer"
                      >
